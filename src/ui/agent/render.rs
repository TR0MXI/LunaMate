...
use gpui::{
    Animation, AnimationExt as _, AnyElement, Context, IntoElement, MouseButton, ObjectFit, Render,
    Window, div, img, prelude::*, px, svg,
};
use gpui_component::{StyledExt as _, input::Input, tooltip::Tooltip};
use rust_i18n::t;

use crate::ui::UiPalette;

use super::{
    AgentOverlayLayout, AgentView,
    reply::{
