...
pub(super) fn section_label(title: String, palette: UiPalette) -> Div {
    div()
        .pt_6()
        .pb_2()
        .text_xs()
...
pub(super) fn form_field(label: String, control: impl IntoElement, palette: UiPalette) -> Div {
    div()
        .flex_1()
        .min_w_0()
        .min_h(px(78.0))
...
pub(super) fn toggle_switch(id: &'static str, checked: bool, palette: UiPalette) -> Stateful<Div> {
    div()
        .id(id)
        .w(px(34.0))
        .h(px(18.0))
