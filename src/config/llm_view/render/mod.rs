...
impl Render for LlmSettingsView {
...
fn section_label(title: String, palette: UiPalette) -> gpui::Div {
    div()
        .pt_6()
        .pb_2()
        .text_xs()
...
fn form_field(label: String, control: impl IntoElement, palette: UiPalette) -> gpui::Div {
    div()
        .flex_1()
        .min_w_0()
        .min_h(px(78.0))
